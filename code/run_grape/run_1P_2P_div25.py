...
def run_2P_1P_CNOTs(tN,N, nS=15, Bz=0, max_time = 24*3600, lam=0, prev_grape_fn=None, verbosity=2, reverse_CX=False, kappa=1):
    ...
    if prev_grape_fn is None:
        ...
        grape = load_grape(prev_grape_fn, max_time=max_time, Grape=GrapeESR_AJ_Modulation, verbosity=verbosity, kappa=kappa, minus_phase=True)
...
if __name__ == '__main__':
    ...
    run_2P_1P_CNOTs(5000*unit.ns, 10000, nS=69, max_time = 23.5*3600, lam=1e8, prev_grape_fn=None, reverse_CX=False, kappa=1e2)
