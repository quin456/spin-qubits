...
def run_CNOTs(tN,N, nq=3,nS=15, Bz=0, max_time = 24*3600, J=None, A=None, save_data=True, show_plot=True, rf=None, prev_grape_fn=None, kappa=1, minprint=False, mergeprop=False, lam=0, alpha=0):
    ...
    if A is None: A = get_A(nS, nq, NucSpin=[1,1,0])
    if J is None: J = get_J(nS, nq, J1=J_110_18nm[:9], J2=J_110_18nm[:9])/div
...
if __name__ == '__main__':
    ...
    #run_CNOTs(tN = 1000.0*unit.ns, N = 500, nq = 3, nS = 45, max_time = 60, save_data = True, lam=0, prev_grape_fn='fields/c928_45S_3q_1000ns_500step')
    run_CNOTs(tN = 5000.0*unit.ns, N = 5000, nq = 3, nS = 81, max_time = 23.5*3600, save_data = True, lam=1e9, alpha=0, prev_grape_fn='g252_81S_3q_5000ns_5000step')
    plt.show()
